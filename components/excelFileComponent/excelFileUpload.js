...
export default function excelfileupload() {
  ...
  const onSubmit = async (data) => {
    try {
      console.log(data)
      const response = await axios.post(process.env.NEXT_PUBLIC_API_URL + '/soal/import-file', data, {
        headers: {
      ...
      <Box component="form" onSubmit={handleSubmit(onSubmit)}
        ...
        >
          <IconButton
            ...
            component="label"
          >
            <input accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" type="file" onChange={handleChange} />
