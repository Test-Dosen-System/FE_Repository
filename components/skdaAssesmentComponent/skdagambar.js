...
export default function skdagambar() {
  ...
  const [imageA, setImageA] = useState({ preview: '/upload.png', raw: '' })
  const [imageB, setImageB] = useState({ preview: '/upload.png', raw: '' })
  const [imageC, setImageC] = useState({ preview: '/upload.png', raw: '' })
  const [imageD, setImageD] = useState({ preview: '/upload.png', raw: '' })
  const [imageE, setImageE] = useState({ preview: '/upload.png', raw: '' })
  const part_soal = "FIGUR ANALYSIS AND SYNTHESIS"
  ...
  useEffect(() => {
    ...
    setValue("part_soal", part_soal)
    // if (imageE) {
    //   setValue("jawaban_e", imageE.raw)
    // }
  }, [image, imageA, imageB, imageC, imageD, setValue])
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={6} lg={6}>
          ...
          <IconButton
            ...
            component="label"
          >
            <input hidden accept="image/*" type="file" onChange={handleChangeA} />
            <AddAPhotoIcon
              sx={{
                width: 35,
                height: 35,
        ...
        <Grid item xs={12} md={6} lg={6}>
          ...
          <IconButton
            ...
            component="label"
          >
            <input hidden accept="image/*" type="file" onChange={handleChangeB} />
            <AddAPhotoIcon
              sx={{
                width: 35,
                height: 35,
        ...
        <Grid item xs={12} md={6} lg={6}>
          ...
          <IconButton
            ...
            component="label"
          >
            <input hidden accept="image/*" type="file" onChange={handleChangeC} />
            <AddAPhotoIcon
              sx={{
                width: 35,
                height: 35,
        ...
        <Grid item xs={12} md={6} lg={6}>
          ...
          <IconButton
            ...
            component="label"
          >
            <input hidden accept="image/*" type="file" onChange={handleChangeD} />
            <AddAPhotoIcon
              sx={{
                width: 35,
                height: 35,
